...
export default function Shopping() {
    ...
    useEffect(() => {
        ...
        var productsToLoad = localStorage.getItem('cart');
                ...
                <div className="grid grid-cols-12">
                    <div
                        ...
                        <div className="flex items-center justify-between pb-8 border-b border-gray-300">
                            ...
                            <h2 className="font-manrope font-bold text-xl leading-8 text-gray-600">{stringItems}</h2>
                        </div>
                                ...
                                <div key={item.productId}
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 w-full">
                                        ...
                                        <div className="flex items-center max-[500px]:justify-center md:justify-end max-md:mt-3 h-full">
                                            <p className="font-bold text-lg leading-8 text-gray-600 text-center transition-all duration-300 group-hover:text-indigo-600">{item.total}</p>
                                        </div>
                                    </div>
                                </div>
                            ))}
                    ...
                    <div
                        ...
                        <div className="mt-8">
                            <div className="flex items-center justify-between pb-6">
                                <p className="font-normal text-lg leading-8 text-black">{stringItems}</p>
                                <p className="font-medium text-lg leading-8 text-black">{stringTotal}</p>
                            </div>
                            <form>
                                ...
                                <div className="flex items-center justify-between py-8">
                                    <p className="font-medium text-xl leading-8 text-black">{stringItems}</p>
